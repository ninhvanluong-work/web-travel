...
export function useBookingSheetState(adultPrice: number, currency: string) {
  ...
  if (packageType === 'premium') premiumSurcharge = currency === '₫' ? 1000000 : 40;
