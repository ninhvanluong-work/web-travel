      ...
      <div className="grid grid-cols-3 gap-3">
        <div className="space-y-1">
          ...
          <Input
            ...
            size="sm"
            min={0}
            value={value.adult_price}
            onChange={(e) => set({ adult_price: Number(e.target.value) })}
          />
        </div>
        <div className="space-y-1">
          ...
          <Input
            ...
            onChange={(e) => set({ child_price: Number(e.target.value) })}
          />
        </div>
        <div className="space-y-1">
          ...
          <Input
            ...
            size="sm"
            min={0}
            value={value.infant_price}
            onChange={(e) => set({ infant_price: Number(e.target.value) })}
          />
        </div>
      </div>
