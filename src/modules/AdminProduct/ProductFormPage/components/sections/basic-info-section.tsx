    ...
    <div className="space-y-5">
      ...
      <FormField
        ...
        render={({ field }) => (
          <FormItem>
            <FormLabel>
              Slug (URL) <span className="text-xs text-gray-400 font-normal ml-1">tự động tạo từ tên</span>
            </FormLabel>
            <FormControl>
              <Input size="sm" placeholder="tu-dong-tao-tu-ten" {...field} className="bg-gray-50 text-gray-500" />
            </FormControl>
            <FormMessage />
          </FormItem>
        )}
